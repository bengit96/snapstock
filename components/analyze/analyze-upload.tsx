...
import { Upload, Sparkles, Check, ArrowLeft } from 'lucide-react'
          ...
          >
            ...
            <div className="mb-8">
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 rounded-full mb-6"
              >
              ...
              <motion.p
                ...
                className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-4 px-4"
              >
                  ...
                  <div className="text-center space-y-6">
                    ...
                    <div className="max-w-lg mx-auto pt-4">
                      ...
                      <div className="flex flex-wrap items-center justify-center gap-2">
                        <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-white/80 dark:bg-gray-800/80 text-gray-700 dark:text-gray-300 border border-purple-200/50 dark:border-purple-700/50">
                          1-5min timeframe
                        </span>
                        <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-white/80 dark:bg-gray-800/80 text-gray-700 dark:text-gray-300 border border-purple-200/50 dark:border-purple-700/50">
                          MACD
